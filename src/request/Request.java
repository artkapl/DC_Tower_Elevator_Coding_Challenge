...
/**
 * The type Request. A request consists of the current floor from which an elevator was requested, the intended destination and the direction the elevator needs to travel.
 *
